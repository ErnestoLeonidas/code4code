/* ==============================================
   ejercicios-python-data.js — Banco de ejercicios Python
   Carga los ejercicios normalizados desde json/python/N*.json
   (mismo patrón que ejercicios-data.js para LiteSeInt y
   ejercicios-pseint-data.js para PSeInt).
   ============================================== */
...
(function (global) {
  ...
  function porNivel(nivel) {
    return EJERCICIOS.filter(
      (e) => e.estadoAdaptacion === 'adaptado' && e.nivelPython === nivel,
    );
  }

  global.EjerciciosPython = {
    EJERCICIOS,
