...
function configurarIO() {
  ...
  pyodide.runPython([
    ...
    '    global _resolver_entrada',
    '    # El prompt y el valor los muestra la consola inline (host.leer),',
    '    # no se escriben a stdout para no duplicar el eco.',
    '    # Crear la Promise ANTES de enviar el mensaje (evita carreras).',
